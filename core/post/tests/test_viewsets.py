...
class TestPostViewSet:
    ...
    ###### Эти тесты запускаются только в том случае, если пользователь аутентифицирован ##############
    ...
    def test_create(self, client, user):
        client.force_authenticate(user=user)
        data = {"body": "Тестовое описание поста.", "author": user.public_id.hex}
    ...
    ####### Эти тесты запускаются только в том случае, если пользователь не аутентифицирован #########
    ...
    def test_create_anonymous(self, client):
        data = {"body": "Тестовое описание поста.", "author": "test_user"}
        response = client.post(self.endpoint, data)
